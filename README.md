...
<h2>Computer Science • Future‑Focused • Creative Thinker</h2>
...
<div style="margin-top: 20px;">
  ...
  <ul style="margin-left: 20px;">
    <li style="margin-bottom: 8px;">🏗️ <a href="./software-design.md">Software Design and Engineering (SNHU Travel System)</a>
